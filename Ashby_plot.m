...
% 设置轴和标题
xlabel('Starting Frequency (Hz)', 'FontName', 'Calibri', 'FontSize', 15, 'FontWeight', 'bold');
ylabel('Loading (N)', 'FontName', 'Calibri', 'FontSize', 15, 'FontWeight', 'bold');
title('Vibration Isolator Operation Range - Loading and Starting Frequency', 'FontName', 'Calibri', 'FontSize', 15, 'FontWeight', 'bold');
...
plot(res_f,res_N,'--','Color','#d92523')
plot(res_f*sqrt(2),res_N,'g','Color','#2e974e')
...
% 标注文字内容
text(200, 350, 'Resonance frequency: $f=\frac{1}{2\pi}\sqrt{\frac{k}{m}}$','Interpreter','latex', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 15, 'Color', '#d92523');
text(300,300, 'Cut-off frequency: $f=\frac{\sqrt{2}}{2\pi}\sqrt{\frac{k}{m}}$','Interpreter','latex', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 15, 'Color', '#2e974e');

text(30,20, 'Nonlinear beam design', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 12);


text(500, 250, 'Linear Isolators', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 12);
text(300, 50, 'Negative Stiffness Mechanism', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 12);
text(150, 200, 'QZS Isolators', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 12);
text(100, 150, 'Magnets', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom','FontSize', 12);

text(250, 100, 'This work', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 15, 'FontWeight', 'bold', 'Color', 'blue');
...
ylabel('Loading (N)', 'FontName', 'Calibri', 'FontSize', 15, 'FontWeight', 'bold');
title('Ultra-low Frequency Vibration Isolator Operation Range', 'FontName', 'Calibri', 'FontSize', 15, 'FontWeight', 'bold');
grid on
box on
% 设置轴范围
xlim([0 50]);
...
text(5, 81, 'Chai, Y., et al. (2022)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
...
text(22, 27, 'Zhang, Q., et al. (2021)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
...
y_right = y_left;     % 右侧工字端的y坐标
text(25, 15, 'Jiahao Zhou, et al.(2024)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
...
x_right = [39.8 39.8 40 40];  % 右侧工字端的x坐标
y_right = y_left;     % 右侧工字端的y坐标
text(20, 5, 'Banerjee, P., et al. (2023)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
...
y_right = y_left;     % 右侧工字端的y坐标
text(6, 51, 'Ye, K., et al. (2020)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
...
y_right = y_left;     % 右侧工字端的y坐标
text(2, 16, 'Yang, H. and H. Zhao (2024)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
...
y_right = y_left;     % 右侧工字端的y坐标
text(27, 65, 'Ling, P., et al. (2022)','FontName', 'Calibri', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'FontSize', 12);
% 绘制横轴线段
line(x_center, y_center, 'LineWidth', 2, 'Color', 'r');
% 绘制左侧工字端
patch(x_left, y_left, 'r', 'EdgeColor', 'r', 'LineWidth', 2);
